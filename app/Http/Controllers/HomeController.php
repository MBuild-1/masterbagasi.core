...
class HomeController extends Controller
{
    ...
    public function brands($brand_slug)
    {
        ...
        if ($brands) {
            ...
            $latest = $brands->Products()->orderBy('created_at', 'desc')->get();
            $best_seller = $brands->Products()->orderBy('sold', 'desc')->get();
            return view('brands.brands', compact('brands', 'products', 'best_seller', 'latest'));
        } else {
            return redirect()->back();
        }
    }
