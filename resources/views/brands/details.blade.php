    ...
    <div class="container pt-4">
        ...
        <div id="detail-product">
            <div class="row my-3">
                            ...
                            <li class="list-group-item">
                                <div class="wrap-breadcrumb det-cat pb-2">
                                    <ul class="det-cat">
                                        ...
                                        <li class="item-link"><a href="{{ url('brands/'.$brands->slug) }}"
                                                class="link">{{ $brands->name }}</a></li>
                ...
                <livewire:frontend.product.view-brand :brands="$brands" :products="$products" />
            </div>
