    ...
    <div class="container pt-4">
        ...
        <div id="detail-product">
            <div class="row my-3">
                            ...
                            <li class="list-group-item">
                                <div class="wrap-breadcrumb det-cat pb-2">
                                    <ul class="det-cat">
                                        ...
                                        <li class="item-link"><a href="{{ url('hastag/'.$viral->slug) }}"
                                                class="link">{{ $viral->name }}</a></li>
                ...
                <livewire:frontend.hastag.viral  :viral="$viral" :products="$products" />
            </div>
                                    ...
                                    <div class="diskusiBody">
                                            <div class="qna" style="margin-bottom:0">
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <p class="fw-bold">Hebrondi</p>
                                                        <p>Jadi gini bang... anjay sotoy</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="container py-4" style="padding-left: 80px;">
                                                    <div class="row">
                                                        <div class="col py-3 d-flex">
                                                            ...
                                                            <div>
                                                                <p class="fw-bold" style="margin-bottom: 0">Miftandi</p>
                                                                <p>Tapi...</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-floating my-4">
                                                ...
                                                <div class="qna" style="margin-bottom:0">
                                                    ...
                                                    <button type="button" class="btn btn-secondary btn-sm">Ikuti
                                                        Diskusi</button>
                                                </div>
                                              </div>
        ...
        {{-- Category --}}
        @if ($categories[0]->category !== null && $categories->count() !== 0)
        ...
        {{-- Brands --}}
        @if ($brands[0]->category !== null && $brands->count() !== 0)
        <section class="viral-wrap my-3">
            <div class="bg-cat">
                <div class="row">
                    <div class="col-8 d-flex my-auto">
        ...
        @if ($brands[0]->category == null)
        <section class="viral-wrap my-3">
            <div class="bg-cat">
                <div class="row">
                    <div class="col-8 d-flex my-auto">
                        <p class="px-4 mb-0" style="font-size: 40px; font-weight:500; letter-spacing: -1px">Produk Lainnya di Bundling</p>
                    </div>
                    <div class="col-4 d-flex justify-content-end my-auto">
                    </div>
                </div>
            ...
            <div class="container mb-5">
                <div class="bks-cat">
                    <div id="carou-cat3" class="hashtag owl-carousel owl-theme">
                        @foreach ($brands as $product)
                        <a href="{{url('hastag/bundling/'.$product->slug)}}" style="text-decoration: none; color:black;">
                            <div class="ms-2 me-2">
                                <div class="d-flex flex-wrap gap-4">
                                    <div class="card card-product mt-2">
                                        <div class="card-header p-0">
