...
<main class="mt-5 pt-4 container">
    <div class="row mb-3 position-sticky" style="top: 63px; z-index: 1;">
        <div class="cektarif-dd col-9 h-100">
            <select class="form-select select2 test-ulasan shadow" aria-label="Default select example" wire:model='country'>
        ...
        <div class="col-3">
            <button class="btn btn-primary w-100 h-100 shadow" wire:click.prevent='cekHarga'><span>Cek Tarif</span></button>
        </div>
    </div>
    <div class="">
        <div class="row">
