<div class="row">
  ...
  <div class="col-sm " >
    <div id="carouselYutup" class="carousel slide" data-bs-ride="carousel" data-bs-interval="false">
      <div class="carousel-inner bnr-size">
        <div class="carousel-item active">
          <iframe class="img-edit" width="100%" height="100%" src="https://www.youtube.com/embed/JpBvYhcHaK0?controls=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        <div class="carousel-item">
          <iframe class="img-edit" width="100%" height="100%" src="https://www.youtube.com/embed/JpBvYhcHaK0?controls=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
